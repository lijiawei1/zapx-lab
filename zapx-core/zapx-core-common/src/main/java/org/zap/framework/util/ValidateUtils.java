...
public class ValidateUtils {
     ...
     *
     */
    public static final String REGULAR_IP = "(2[5][0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})\\.(25[0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})\\.(25[0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})\\.(25[0-5]|2[0-4]\\d|1\\d{2}|\\d{1,2})";
    ...
    public static final String MOBILE_STRICT = "^(1[3|4|5|7|8])\\d{9}$";
    ...
    /**
     * 正Double正则表达式  ^[1-9]\d*\.\d*|0\.\d*[1-9]\d*|0?\.0+|0$
     */
    ...
    public static boolean isIP(String ipAddress) {
        Pattern pattern = Pattern.compile(REGULAR_IP);
    ...
    public static boolean isMobile(String str) {
        return regular(str, MOBILE_STRICT);
    }
