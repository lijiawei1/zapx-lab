...
public class DateUtils {
	 ...
	 * ORACLE 10g数据库时间格式
	 */
	public static String PATTERN_ORACLE_DATETIME = "yyyy-mm-dd hh24:mi:ss";
	public static String PATTERN_ORACLE_TIME = "hh24:mi:ss";
	public static String PATTERN_ORACLE_DATE = "yyyy-mm-dd";
	 ...
	 * 时间点的 CRON表达式
	 */
	public static String PATTERN_CRON = "ss mm HH dd MM ? yyyy";
	...
	public static DateTimeFormatter FORMATTER_CRON = DateTimeFormatter.ofPattern(PATTERN_CRON).withZone(ZoneId.systemDefault());
